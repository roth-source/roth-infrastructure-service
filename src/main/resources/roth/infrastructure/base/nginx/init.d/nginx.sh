...
DAEMON=${DAEMON:-$NGINXPATH/home/bin/nginx}   # path to daemon binary
NGINX_CONF_FILE=${NGINX_CONF_FILE:-$NGINXPATH/base/etc/nginx.conf} # config file path

PIDNAME=${PIDNAME:-"nginx"}                   # lets you do $PS-slave
PIDFILE=${PIDFILE:-$PIDNAME.pid}              # pid file
PIDSPATH=${PIDSPATH:-$NGINXPATH/base/log}     # default pid location, you should change it
RUNAS=${RUNAS:-nginx}                         # user to run as
